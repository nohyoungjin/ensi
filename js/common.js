$(function() {
	...
	function lstWalk() {	
		...
		$('.lst_walk').waypoint(function() {
			...
			tl.from('.num_1', 1, {scrambleText: {text: '0', chars: '12345678910', revealDelay: 0.1, tweenLength: false, speed: 0.9, ease: Linear.easeNone} })
			tl.from('.num_2', 1, {scrambleText: {text: '0', chars: '12345678910', revealDelay: 0.1, tweenLength: false, speed: 0.9, ease: Linear.easeNone} })
			tl.from('.num_3', 1, {scrambleText: {text: '0', chars: '12345678910', revealDelay: 0.1, tweenLength: false, speed: 0.9, ease: Linear.easeNone} })
			tl.from('.num_4', 1, {scrambleText: {text: '0', chars: '12345678910', revealDelay: 0.1, tweenLength: false, speed: 0.9, ease: Linear.easeNone} })
